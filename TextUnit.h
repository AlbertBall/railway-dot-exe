...
//functions defined in .cpp file
    ...
    bool FontSame(int Caller, TFont *ExistingFont, TFont *InputFont); //checks colour, size, name, charset and style
    ...
    //if found
    int GetFontStyleAsInt(int Caller, TFont *InputFont); //retrieve the style of the font as a coded integer
    ...
    TFontStyles TTextHandler::SetFontStyleFromInt(int Caller, int Input); //used in loading from a file

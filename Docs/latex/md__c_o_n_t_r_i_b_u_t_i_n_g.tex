...
\href{\#what-should-i-know-before-i-get-started-as-a-contributor}{\texttt{ What should I know before I get started as a contributor?}}
\begin{DoxyItemize}
\item \href{\#railway-dot-exe-and-c++}{\texttt{ Railway-\/dot-\/exe and C++}}
\end{DoxyItemize}
...
\item \href{\#suggested-enhancements}{\texttt{ Suggested Enhancements}}
\end{DoxyItemize}

\href{\#styleguides}{\texttt{ Styleguides}}
\begin{DoxyItemize}
\item \href{\#git-commit-messages}{\texttt{ Git Commit Messages}}
\item \href{\#editing-the-developer-guide}{\texttt{ Editing the Developer Guide}}
\end{DoxyItemize}

\href{\#attributions}{\texttt{ Attributions}}

\doxysection*{Code of Conduct}

Be nice to each other. Please report unacceptable behaviour to \href{mailto:railwayfeedback@gmail.com}{\texttt{ railwayfeedback@gmail.\+com}}.

\doxysection*{I don\textquotesingle{}t want to read this whole thing I just have a question!!!}

We have an official \href{http://www.railwayoperationsimulator.com}{\texttt{ website}} where you can ask questions via the \href{http://www.railwayoperationsimulator.com/contact}{\texttt{ Contact}} form, or simply \href{mailto:railwayfeedback@gmail.com}{\texttt{ Email us}}.

\doxysection*{What should I know before I get started as a contributor?}

\doxysubsection*{Railway-\/dot-\/exe and C++}
...
\begin{DoxyItemize}
\item \href{https://www.embarcadero.com/products/cbuilder/start-for-free}{\texttt{ Embarcadero C++ Starter Edition}}
\end{DoxyItemize}

\doxysection*{How Can I Contribute?}

\doxysubsection*{Reporting Bugs}

Use the Issues tab on our project page to report a bug. See the guide \href{https://guides.github.com/features/issues/}{\texttt{ Git\+Hub issues}} if you need help with creating an Issue .

\doxysubsubsection*{How Do I Submit A (Good) Bug Report?}
...
\doxysubsection*{Suggested Enhancements}
...
\doxysection*{Styleguides}

\doxysubsection*{Git Commit Messages}
...
\doxysubsection*{Editing the Developer Guide}


\begin{DoxyItemize}
\item If you want access to the source copy of the Developer Guide (used to produce the P\+DF version on Git\+Hub) just \href{mailto:railwayfeedback@gmail.com}{\texttt{ Email us}} asking for access.
\end{DoxyItemize}

\doxysection*{Attributions}

Menu icons from Silk Icon Set 1.\+3 by Mark James used under Creative Commons Attribution 2.\+5 License \href{http://creativecommons.org/licenses/by/2.5/}{\texttt{ http\+://creativecommons.\+org/licenses/by/2.\+5/}}

Timetable editor icons from \href{https://icons8.com}{\texttt{ https\+://icons8.\+com}} used under Creative Commons Attribution-\/\+No\+Derivs 3.\+0 Unported License \href{http://creativecommons.org/licenses/by-nd/3.0/}{\texttt{ http\+://creativecommons.\+org/licenses/by-\/nd/3.\+0/}} 
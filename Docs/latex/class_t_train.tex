...
\index{T\+Train@{T\+Train}!Calc\+Time\+To\+Act@{Calc\+Time\+To\+Act}}
\index{Calc\+Time\+To\+Act@{Calc\+Time\+To\+Act}!T\+Train@{T\+Train}}
\subsubsection{\texorpdfstring{Calc\+Time\+To\+Act()}{CalcTimeToAct()}}

...
/// Reset the zoomed-in screen display to the 'Home' position
    void ResetZoomInOffsets() {
        DisplayOffsetH = DisplayOffsetHHome; DisplayOffsetV = DisplayOffsetVHome;
    }
/// Reset the zoomed-out screen display to the 'Home' position
    void ResetZoomOutOffsets() {
        DisplayZoomOutOffsetH = DisplayZoomOutOffsetHHome; DisplayZoomOutOffsetV = DisplayZoomOutOffsetVHome;
    }

    ...
    : TForm(Owner)
{
    ...
    AnsiString TempFunctionString[NumberOfCalls] =
    {
        ...
        "OneLengthOrSpeedHeatMapColour",
        "OneNamedLocationElementAtLocation",
        "OneNonStationLongEnoughForSplit",
        "OneStationLongEnoughForSplit",
        "Operate",
        "OtherTrainOnTrack",
        "PerformanceLog",
        ...
        "TextFound",
        "TextOut",
        "ThisNonStationLongEnoughForSplit",
        "ThisStationLongEnoughForSplit",

\hypertarget{class_t_train}{}\doxysection{T\+Train Class Reference}
\label{class_t_train}\index{TTrain@{TTrain}}
...
\begin{DoxyCompactList}\small\item\em new v2.\+2.\+0 for operator action panel. Calculates the time left for operator action to avoid unnecessary delays \end{DoxyCompactList}\item 
...
\mbox{\Hypertarget{class_t_train_ab1d46932f9ed9e6d0a3ee2f3e76d1705}\label{class_t_train_ab1d46932f9ed9e6d0a3ee2f3e76d1705}} 
float \mbox{\hyperlink{class_t_train_ab1d46932f9ed9e6d0a3ee2f3e76d1705}{Mins\+Delayed}}
\begin{DoxyCompactList}\small\item\em new at v2.\+2.\+0 for operator time to act panel. Calculated in Update\+Train \end{DoxyCompactList}\item 
\mbox{\Hypertarget{class_t_train_a324320d17dcf544cb0507b909ac14975}\label{class_t_train_a324320d17dcf544cb0507b909ac14975}} 
float \mbox{\hyperlink{class_t_train_a324320d17dcf544cb0507b909ac14975}{Op\+Time\+To\+Act}}
\begin{DoxyCompactList}\small\item\em in minutes\+: new at v2.\+2.\+0 for operator time to act panel. Calculated in Update\+Train, -\/1 indicates not to be displayed on panel \end{DoxyCompactList}\item 
\mbox{\Hypertarget{class_t_train_a0188ccc7d6e918b6522a72addfb96d0d}\label{class_t_train_a0188ccc7d6e918b6522a72addfb96d0d}} 
...
\begin{DoxyCompactList}\small\item\em Watts (i.\+e. 100MW) \end{DoxyCompactList}\item 
...
\mbox{\Hypertarget{class_t_train_ae34370de578ebd07a217c79d8b67312c}\label{class_t_train_ae34370de578ebd07a217c79d8b67312c}} 
\index{TTrain@{TTrain}!CalcTimeToAct@{CalcTimeToAct}}
\index{CalcTimeToAct@{CalcTimeToAct}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{CalcTimeToAct()}{CalcTimeToAct()}}
...
New v2.\+2.\+0 for operator action panel. Calls Calc\+Distance To\+Red\+Signal and uses the current speed to estimate the time in minutes assuming a constant deceleration rate to it. If a buffer, continuation, stopping location, an autosignal route after the next red signal, or service finished, then -\/1 is returned to signal that there is to be no display for that train. If stopped at a location the time is still calculated assuming a speed of 30km/h and the time to start added to it. \mbox{\Hypertarget{class_t_train_a50997f7e8138a7e6a147fe3b5ad21b84}\label{class_t_train_a50997f7e8138a7e6a147fe3b5ad21b84}} 
\index{TTrain@{TTrain}!CheckAndCancelRouteForWrongEndEntry@{CheckAndCancelRouteForWrongEndEntry}}
\index{CheckAndCancelRouteForWrongEndEntry@{CheckAndCancelRouteForWrongEndEntry}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{CheckAndCancelRouteForWrongEndEntry()}{CheckAndCancelRouteForWrongEndEntry()}}
...
\index{TTrain@{TTrain}!CheckOneSessionTrain@{CheckOneSessionTrain}}
\index{CheckOneSessionTrain@{CheckOneSessionTrain}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{CheckOneSessionTrain()}{CheckOneSessionTrain()}}
...
\index{TTrain@{TTrain}!ClearToNextSignal@{ClearToNextSignal}}
\index{ClearToNextSignal@{ClearToNextSignal}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{ClearToNextSignal()}{ClearToNextSignal()}}
...
\index{TTrain@{TTrain}!DeleteTrain@{DeleteTrain}}
\index{DeleteTrain@{DeleteTrain}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{DeleteTrain()}{DeleteTrain()}}
...
\index{TTrain@{TTrain}!GetLeadElement@{GetLeadElement}}
\index{GetLeadElement@{GetLeadElement}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{GetLeadElement()}{GetLeadElement()}}
...
\index{TTrain@{TTrain}!GetTrainTime@{GetTrainTime}}
\index{GetTrainTime@{GetTrainTime}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{GetTrainTime()}{GetTrainTime()}}
...
\index{TTrain@{TTrain}!LinkOccupied@{LinkOccupied}}
\index{LinkOccupied@{LinkOccupied}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{LinkOccupied()}{LinkOccupied()}}
...
\index{TTrain@{TTrain}!LogAction@{LogAction}}
\index{LogAction@{LogAction}!TTrain@{TTrain}}
...
\index{TTrain@{TTrain}!LowEntryValue@{LowEntryValue}}
\index{LowEntryValue@{LowEntryValue}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{LowEntryValue()}{LowEntryValue()}}
...
\index{TTrain@{TTrain}!NameInTimetableBeforeCDT@{NameInTimetableBeforeCDT}}
\index{NameInTimetableBeforeCDT@{NameInTimetableBeforeCDT}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{NameInTimetableBeforeCDT()}{NameInTimetableBeforeCDT()}}
...
\index{TTrain@{TTrain}!PickUpBackgroundBitmap@{PickUpBackgroundBitmap}}
\index{PickUpBackgroundBitmap@{PickUpBackgroundBitmap}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{PickUpBackgroundBitmap()}{PickUpBackgroundBitmap()}}
...
\index{TTrain@{TTrain}!PlotAlternativeTrackRouteGraphic@{PlotAlternativeTrackRouteGraphic}}
\index{PlotAlternativeTrackRouteGraphic@{PlotAlternativeTrackRouteGraphic}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{PlotAlternativeTrackRouteGraphic()}{PlotAlternativeTrackRouteGraphic()}}
...
\index{TTrain@{TTrain}!RepeatShuttleOrNewNonRepeatService@{RepeatShuttleOrNewNonRepeatService}}
\index{RepeatShuttleOrNewNonRepeatService@{RepeatShuttleOrNewNonRepeatService}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{RepeatShuttleOrNewNonRepeatService()}{RepeatShuttleOrNewNonRepeatService()}}
...
\index{TTrain@{TTrain}!RepeatShuttleOrRemainHere@{RepeatShuttleOrRemainHere}}
\index{RepeatShuttleOrRemainHere@{RepeatShuttleOrRemainHere}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{RepeatShuttleOrRemainHere()}{RepeatShuttleOrRemainHere()}}
...
\index{TTrain@{TTrain}!ResetTrainElementID@{ResetTrainElementID}}
\index{ResetTrainElementID@{ResetTrainElementID}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{ResetTrainElementID()}{ResetTrainElementID()}}
...
\index{TTrain@{TTrain}!SetHeadCodeGraphics@{SetHeadCodeGraphics}}
\index{SetHeadCodeGraphics@{SetHeadCodeGraphics}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{SetHeadCodeGraphics()}{SetHeadCodeGraphics()}}
...
\index{TTrain@{TTrain}!SetTrainElementID@{SetTrainElementID}}
\index{SetTrainElementID@{SetTrainElementID}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{SetTrainElementID()}{SetTrainElementID()}}
...
\index{TTrain@{TTrain}!WriteTrainToImage@{WriteTrainToImage}}
\index{WriteTrainToImage@{WriteTrainToImage}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{WriteTrainToImage()}{WriteTrainToImage()}}
...
\index{TTrain@{TTrain}!AllowedToPassRedSignal@{AllowedToPassRedSignal}}
\index{AllowedToPassRedSignal@{AllowedToPassRedSignal}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{AllowedToPassRedSignal}{AllowedToPassRedSignal}}
...
\index{TTrain@{TTrain}!BufferZoomOutFlashRequired@{BufferZoomOutFlashRequired}}
\index{BufferZoomOutFlashRequired@{BufferZoomOutFlashRequired}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{BufferZoomOutFlashRequired}{BufferZoomOutFlashRequired}}
...
\index{TTrain@{TTrain}!DepartureTimeSet@{DepartureTimeSet}}
\index{DepartureTimeSet@{DepartureTimeSet}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{DepartureTimeSet}{DepartureTimeSet}}
...
\index{TTrain@{TTrain}!FirstHalfMove@{FirstHalfMove}}
\index{FirstHalfMove@{FirstHalfMove}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{FirstHalfMove}{FirstHalfMove}}
...
\index{TTrain@{TTrain}!HeadCodePosition@{HeadCodePosition}}
\index{HeadCodePosition@{HeadCodePosition}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{HeadCodePosition}{HeadCodePosition}}
...
\index{TTrain@{TTrain}!JoinedOtherTrainFlag@{JoinedOtherTrainFlag}}
\index{JoinedOtherTrainFlag@{JoinedOtherTrainFlag}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{JoinedOtherTrainFlag}{JoinedOtherTrainFlag}}
...
\index{TTrain@{TTrain}!LastActionDelayFlag@{LastActionDelayFlag}}
\index{LastActionDelayFlag@{LastActionDelayFlag}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{LastActionDelayFlag}{LastActionDelayFlag}}
...
\index{TTrain@{TTrain}!LeavingUnderSigControlAtContinuation@{LeavingUnderSigControlAtContinuation}}
\index{LeavingUnderSigControlAtContinuation@{LeavingUnderSigControlAtContinuation}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{LeavingUnderSigControlAtContinuation}{LeavingUnderSigControlAtContinuation}}
...
\index{TTrain@{TTrain}!NextTrainID@{NextTrainID}}
\index{NextTrainID@{NextTrainID}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{NextTrainID}{NextTrainID}}
...
\index{TTrain@{TTrain}!OldZoomOutElement@{OldZoomOutElement}}
\index{OldZoomOutElement@{OldZoomOutElement}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{OldZoomOutElement}{OldZoomOutElement}}
...
\index{TTrain@{TTrain}!OneLengthAccelDecel@{OneLengthAccelDecel}}
\index{OneLengthAccelDecel@{OneLengthAccelDecel}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{OneLengthAccelDecel}{OneLengthAccelDecel}}
...
\index{TTrain@{TTrain}!PlotEntryPos@{PlotEntryPos}}
\index{PlotEntryPos@{PlotEntryPos}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{PlotEntryPos}{PlotEntryPos}}
...
\index{TTrain@{TTrain}!RestoreTimetableLocation@{RestoreTimetableLocation}}
\index{RestoreTimetableLocation@{RestoreTimetableLocation}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{RestoreTimetableLocation}{RestoreTimetableLocation}}
...
\index{TTrain@{TTrain}!SPADFlag@{SPADFlag}}
\index{SPADFlag@{SPADFlag}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{SPADFlag}{SPADFlag}}
...
\index{TTrain@{TTrain}!TrainCrashedInto@{TrainCrashedInto}}
\index{TrainCrashedInto@{TrainCrashedInto}!TTrain@{TTrain}}
\doxysubsubsection{\texorpdfstring{TrainCrashedInto}{TrainCrashedInto}}
...
\index{TTrain@{TTrain}!TrainID@{TrainID}}
\index{TrainID@{TrainID}!TTrain@{TTrain}}
...
\index{TTrain@{TTrain}!UpdateCounter@{UpdateCounter}}
\index{UpdateCounter@{UpdateCounter}!TTrain@{TTrain}}
...
\index{TTrain@{TTrain}!VOffset@{VOffset}}
\index{VOffset@{VOffset}!TTrain@{TTrain}}

\hypertarget{class_t_all_routes}{}\doxysection{T\+All\+Routes Class Reference}
\label{class_t_all_routes}\index{TAllRoutes@{TAllRoutes}}
...
\begin{DoxyCompactItemize}
\item 
enum T\+All\+Routes\+::\+T\+Route\+Type \mbox{\hyperlink{class_t_all_routes_a8b4c0632615307653f3d1a24de9967b3}{Route\+Type}}
...
\index{TAllRoutes@{TAllRoutes}!TRoute2MultiMap@{TRoute2MultiMap}}
\index{TRoute2MultiMap@{TRoute2MultiMap}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{TRoute2MultiMap}{TRoute2MultiMap}}
...
\index{TAllRoutes@{TAllRoutes}!TRouteElementPair@{TRouteElementPair}}
\index{TRouteElementPair@{TRouteElementPair}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{TRouteElementPair}{TRouteElementPair}}
...
\index{TAllRoutes@{TAllRoutes}!AddRouteElement@{AddRouteElement}}
\index{AddRouteElement@{AddRouteElement}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{AddRouteElement()}{AddRouteElement()}}
...
\index{TAllRoutes@{TAllRoutes}!CheckMapAndRoutes@{CheckMapAndRoutes}}
\index{CheckMapAndRoutes@{CheckMapAndRoutes}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{CheckMapAndRoutes()}{CheckMapAndRoutes()}}
...
\index{TAllRoutes@{TAllRoutes}!ClearRouteDuringRouteBuildingAt@{ClearRouteDuringRouteBuildingAt}}
\index{ClearRouteDuringRouteBuildingAt@{ClearRouteDuringRouteBuildingAt}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{ClearRouteDuringRouteBuildingAt()}{ClearRouteDuringRouteBuildingAt()}}
...
\index{TAllRoutes@{TAllRoutes}!DecrementRouteElementNumbersInRoute2MultiMap@{DecrementRouteElementNumbersInRoute2MultiMap}}
\index{DecrementRouteElementNumbersInRoute2MultiMap@{DecrementRouteElementNumbersInRoute2MultiMap}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{DecrementRouteElementNumbersInRoute2MultiMap()}{DecrementRouteElementNumbersInRoute2MultiMap()}}
...
\index{TAllRoutes@{TAllRoutes}!DecrementRouteNumbersInRoute2MultiMap@{DecrementRouteNumbersInRoute2MultiMap}}
\index{DecrementRouteNumbersInRoute2MultiMap@{DecrementRouteNumbersInRoute2MultiMap}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{DecrementRouteNumbersInRoute2MultiMap()}{DecrementRouteNumbersInRoute2MultiMap()}}
...
\index{TAllRoutes@{TAllRoutes}!DiagonalFouledByRouteOrTrain@{DiagonalFouledByRouteOrTrain}}
\index{DiagonalFouledByRouteOrTrain@{DiagonalFouledByRouteOrTrain}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{DiagonalFouledByRouteOrTrain()}{DiagonalFouledByRouteOrTrain()}}
...
\index{TAllRoutes@{TAllRoutes}!FindRouteNumberFromRoute2MultiMapNoErrors@{FindRouteNumberFromRoute2MultiMapNoErrors}}
\index{FindRouteNumberFromRoute2MultiMapNoErrors@{FindRouteNumberFromRoute2MultiMapNoErrors}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{FindRouteNumberFromRoute2MultiMapNoErrors()}{FindRouteNumberFromRoute2MultiMapNoErrors()}}
...
\index{TAllRoutes@{TAllRoutes}!FindRoutePairFromRoute2MultiMap@{FindRoutePairFromRoute2MultiMap}}
\index{FindRoutePairFromRoute2MultiMap@{FindRoutePairFromRoute2MultiMap}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{FindRoutePairFromRoute2MultiMap()}{FindRoutePairFromRoute2MultiMap()}}
...
\index{TAllRoutes@{TAllRoutes}!GetAllRoutesTruncateElement@{GetAllRoutesTruncateElement}}
\index{GetAllRoutesTruncateElement@{GetAllRoutesTruncateElement}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{GetAllRoutesTruncateElement()}{GetAllRoutesTruncateElement()}}
...
\index{TAllRoutes@{TAllRoutes}!GetFixedRouteAt@{GetFixedRouteAt}}
\index{GetFixedRouteAt@{GetFixedRouteAt}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{GetFixedRouteAt()}{GetFixedRouteAt()}}
...
\index{TAllRoutes@{TAllRoutes}!GetModifiableRouteAt@{GetModifiableRouteAt}}
\index{GetModifiableRouteAt@{GetModifiableRouteAt}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{GetModifiableRouteAt()}{GetModifiableRouteAt()}}
...
\index{TAllRoutes@{TAllRoutes}!GetModifiableRouteAtIDNumber@{GetModifiableRouteAtIDNumber}}
\index{GetModifiableRouteAtIDNumber@{GetModifiableRouteAtIDNumber}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{GetModifiableRouteAtIDNumber()}{GetModifiableRouteAtIDNumber()}}
...
\index{TAllRoutes@{TAllRoutes}!GetRouteElementDataFromRoute2MultiMap@{GetRouteElementDataFromRoute2MultiMap}}
\index{GetRouteElementDataFromRoute2MultiMap@{GetRouteElementDataFromRoute2MultiMap}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{GetRouteElementDataFromRoute2MultiMap()}{GetRouteElementDataFromRoute2MultiMap()}}
...
\index{TAllRoutes@{TAllRoutes}!GetRouteTypeAndGraphics@{GetRouteTypeAndGraphics}}
\index{GetRouteTypeAndGraphics@{GetRouteTypeAndGraphics}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{GetRouteTypeAndGraphics()}{GetRouteTypeAndGraphics()}}
...
\index{TAllRoutes@{TAllRoutes}!GetRouteTypeAndNumber@{GetRouteTypeAndNumber}}
\index{GetRouteTypeAndNumber@{GetRouteTypeAndNumber}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{GetRouteTypeAndNumber()}{GetRouteTypeAndNumber()}}
...
\index{TAllRoutes@{TAllRoutes}!IsElementInLockedRouteGetPrefDirElementGetLockedVectorNumber@{IsElementInLockedRouteGetPrefDirElementGetLockedVectorNumber}}
\index{IsElementInLockedRouteGetPrefDirElementGetLockedVectorNumber@{IsElementInLockedRouteGetPrefDirElementGetLockedVectorNumber}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{IsElementInLockedRouteGetPrefDirElementGetLockedVectorNumber()}{IsElementInLockedRouteGetPrefDirElementGetLockedVectorNumber()}}
...
\index{TAllRoutes@{TAllRoutes}!RouteLockingRequired@{RouteLockingRequired}}
\index{RouteLockingRequired@{RouteLockingRequired}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{RouteLockingRequired()}{RouteLockingRequired()}}
...
\index{TAllRoutes@{TAllRoutes}!SetTrailingSignalsOnAutoSigsRoute@{SetTrailingSignalsOnAutoSigsRoute}}
\index{SetTrailingSignalsOnAutoSigsRoute@{SetTrailingSignalsOnAutoSigsRoute}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{SetTrailingSignalsOnAutoSigsRoute()}{SetTrailingSignalsOnAutoSigsRoute()}}
...
\index{TAllRoutes@{TAllRoutes}!SetTrailingSignalsOnContinuationRoute@{SetTrailingSignalsOnContinuationRoute}}
\index{SetTrailingSignalsOnContinuationRoute@{SetTrailingSignalsOnContinuationRoute}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{SetTrailingSignalsOnContinuationRoute()}{SetTrailingSignalsOnContinuationRoute()}}
...
\index{TAllRoutes@{TAllRoutes}!StoreOneRoute@{StoreOneRoute}}
\index{StoreOneRoute@{StoreOneRoute}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{StoreOneRoute()}{StoreOneRoute()}}
...
\index{TAllRoutes@{TAllRoutes}!StoreOneRouteAfterSessionLoad@{StoreOneRouteAfterSessionLoad}}
\index{StoreOneRouteAfterSessionLoad@{StoreOneRouteAfterSessionLoad}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{StoreOneRouteAfterSessionLoad()}{StoreOneRouteAfterSessionLoad()}}
...
\index{TAllRoutes@{TAllRoutes}!TrackIsInARoute@{TrackIsInARoute}}
\index{TrackIsInARoute@{TrackIsInARoute}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{TrackIsInARoute()}{TrackIsInARoute()}}
...
\index{TAllRoutes@{TAllRoutes}!WriteAllRoutesToImage@{WriteAllRoutesToImage}}
\index{WriteAllRoutesToImage@{WriteAllRoutesToImage}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{WriteAllRoutesToImage()}{WriteAllRoutesToImage()}}
...
\index{TAllRoutes@{TAllRoutes}!LockedRouteFoundDuringRouteBuilding@{LockedRouteFoundDuringRouteBuilding}}
\index{LockedRouteFoundDuringRouteBuilding@{LockedRouteFoundDuringRouteBuilding}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{LockedRouteFoundDuringRouteBuilding}{LockedRouteFoundDuringRouteBuilding}}
...
\index{TAllRoutes@{TAllRoutes}!PointsDelay@{PointsDelay}}
\index{PointsDelay@{PointsDelay}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{PointsDelay}{PointsDelay}}
...
\index{TAllRoutes@{TAllRoutes}!RebuildRailwayFlag@{RebuildRailwayFlag}}
\index{RebuildRailwayFlag@{RebuildRailwayFlag}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{RebuildRailwayFlag}{RebuildRailwayFlag}}
...
\index{TAllRoutes@{TAllRoutes}!RouteTruncateFlag@{RouteTruncateFlag}}
\index{RouteTruncateFlag@{RouteTruncateFlag}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{RouteTruncateFlag}{RouteTruncateFlag}}
{\footnotesize\ttfamily bool T\+All\+Routes\+::\+Route\+Truncate\+Flag}

used to flag the fact that a route is being truncated on order to change the behaviour of signal aspect setting in Set\+Rearwards\+Signals\+Return\+False\+For\+Train \mbox{\Hypertarget{class_t_all_routes_a8b4c0632615307653f3d1a24de9967b3}\label{class_t_all_routes_a8b4c0632615307653f3d1a24de9967b3}} 
\index{TAllRoutes@{TAllRoutes}!RouteType@{RouteType}}
\index{RouteType@{RouteType}!TAllRoutes@{TAllRoutes}}
...
\index{TAllRoutes@{TAllRoutes}!SignalsDelay@{SignalsDelay}}
\index{SignalsDelay@{SignalsDelay}!TAllRoutes@{TAllRoutes}}
\doxysubsubsection{\texorpdfstring{SignalsDelay}{SignalsDelay}}

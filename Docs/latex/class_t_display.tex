\hypertarget{class_t_display}{}\doxysection{T\+Display Class Reference}
\label{class_t_display}\index{TDisplay@{TDisplay}}
...
\index{TDisplay@{TDisplay}!TDisplay@{TDisplay}}
\index{TDisplay@{TDisplay}!TDisplay@{TDisplay}}
\doxysubsubsection{\texorpdfstring{TDisplay()}{TDisplay()}}
...
\index{TDisplay@{TDisplay}!GetRectangle@{GetRectangle}}
\index{GetRectangle@{GetRectangle}!TDisplay@{TDisplay}}
...
\index{TDisplay@{TDisplay}!InvertElement@{InvertElement}}
\index{InvertElement@{InvertElement}!TDisplay@{TDisplay}}
\doxysubsubsection{\texorpdfstring{InvertElement()}{InvertElement()}}
...
\index{TDisplay@{TDisplay}!PlotAbsolute@{PlotAbsolute}}
\index{PlotAbsolute@{PlotAbsolute}!TDisplay@{TDisplay}}
\doxysubsubsection{\texorpdfstring{PlotAbsolute()}{PlotAbsolute()}}
...
\index{TDisplay@{TDisplay}!PlotPointBlank@{PlotPointBlank}}
\index{PlotPointBlank@{PlotPointBlank}!TDisplay@{TDisplay}}
\doxysubsubsection{\texorpdfstring{PlotPointBlank()}{PlotPointBlank()}}
...
Plot a small blank rectangle in the centre of a set of points at H\+Loc \& V\+Loc prior to plotting one or both fillets (the movable section) \mbox{\Hypertarget{class_t_display_a6e970089a9419e6bdd12576b6e860c95}\label{class_t_display_a6e970089a9419e6bdd12576b6e860c95}} 
\index{TDisplay@{TDisplay}!PlotSignalBlank@{PlotSignalBlank}}
\index{PlotSignalBlank@{PlotSignalBlank}!TDisplay@{TDisplay}}
\doxysubsubsection{\texorpdfstring{PlotSignalBlank()}{PlotSignalBlank()}}
...
Plot a small blank rectangle over the signal aspect area at H\+Loc \& V\+Loc prior to plotting the current signal aspect \mbox{\Hypertarget{class_t_display_abb140097c975da97aa53bc3946f3ea31}\label{class_t_display_abb140097c975da97aa53bc3946f3ea31}} 
\index{TDisplay@{TDisplay}!PlotSignalBlankOnBitmap@{PlotSignalBlankOnBitmap}}
\index{PlotSignalBlankOnBitmap@{PlotSignalBlankOnBitmap}!TDisplay@{TDisplay}}
\doxysubsubsection{\texorpdfstring{PlotSignalBlankOnBitmap()}{PlotSignalBlankOnBitmap()}}

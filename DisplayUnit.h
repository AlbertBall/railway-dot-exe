...
AnsiString GetFontName() {return Output->Canvas->Font->Name;}
/// Return the size of the default screen font
int GetFontSize() {return Output->Canvas->Font->Size;}
/// Return the height of the screen
int Height() {return Output->Height;}
/// Return the left pixel position of the screen
int Left() {return Output->Left;}
/// Return the top pixel position of the screen
int Top() {return Output->Top;}
/// Return the width of the screen
int Width() {return Output->Width;}
/// Return the current screen font
TFont* GetFont() {return Output->Canvas->Font;}
/// Return a pointer to the screen image
TImage *GetImage() {return Output;}
...
void Cursor(TCursor Cur) {Output->Cursor = Cur;}
/// Reset the zoomed-in screen display to the 'Home' position
void ResetZoomInOffsets() {DisplayOffsetH = DisplayOffsetHHome; DisplayOffsetV = DisplayOffsetVHome;}
/// Reset the zoomed-out screen display to the 'Home' position
void ResetZoomOutOffsets() {DisplayZoomOutOffsetH = DisplayZoomOutOffsetHHome; DisplayZoomOutOffsetV = DisplayZoomOutOffsetVHome;}
/// Set the screen font to 'Font'
void SetFont(TFont* Font) {Output->Canvas->Font->Assign(Font);}
/// Repaint the screen display
void Update() {Output->Update();}
...
TDisplay::TDisplay(TImage* &Image, TMemo* &MemoBox, TLabel* &L1,  TLabel* &L2,
					TLabel* &L3, TLabel* &L4, TLabel* &L5, TLabel* &L6,
					TLabel* &L7,  TLabel* &L8, TLabel* &L9, TLabel* &L10);
